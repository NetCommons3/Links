...
<?php echo $this->Form->create('LinksCategory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Links Category'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LinksCategory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LinksCategory.id'))); ?></li>
